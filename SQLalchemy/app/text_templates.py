...
INFOTEXT = """📱 Обо мне: Ваш автоматизированный магазин в Telegram

Привет! Я — умный бот-магазин, который помогает бизнесу продавать, а покупателям — легко находить и заказывать товары или услуги прямо в Telegram.

🛍️ ДЛЯ ПОКУПАТЕЛЕЙ:

    Каталог товаров — удобный поиск и фильтры

    Корзина и заказ — оформление за пару минут

    Отслеживание статуса — знайте, где ваш заказ

    Поддержка онлайн — отвечаем быстро

💼 ДЛЯ ВЛАДЕЛЬЦЕВ БИЗНЕСА:
Я помогаю автоматизировать продажи, чтобы вы могли сосредоточиться на развитии:

🎯 Преимущества:

    Продажи 24/7 — заказы даже ночью

    Автоматизация рутины — менеджеры тратят меньше времени

    Все данные здесь — товары, клиенты, статистика

    Растём вместе с вами — система масштабируется под ваш рост

📊 Результаты для бизнеса:

    Снижение нагрузки на сотрудников на 60–80%

    Увеличение конверсии на 20–35%

    Обработка заказа за 1–2 минуты

⚙️ ТЕХНИЧЕСКИЕ ВОЗМОЖНОСТИ:

    Универсальность — подходит для любых товаров и услуг

    Интеграция платежей — ЮKassa, Сбербанк, Tinkoff и другие

    Синхронизация с CRM — настраиваемая связь с Битрикс24, amoCRM и др.

    Многоуровневая админка — разные права для владельца, менеджеров, контент-менеджеров

    Безопасность и надёжность — защита данных, резервное копирование

    Дополнительные функции — импорт товаров (CSV), API для интеграций, отчёты

🔧 Технологии: Python, PostgreSQL, модульная архитектура.

❔ ЧАСТО СПРАШИВАЮТ:

    Как начать? — Напишите мне для обсуждения ваших задач

    Можно под мой товар? — Да, адаптируем под любой ассортимент

    Нужен хостинг? — Помогу с размещением или подскажу, где развернуть

    Есть документация? — Предоставим инструкции для вашей команды

📞 СОТРУДНИЧЕСТВО:
Интересует внедрение такого бота для вашего бизнеса?
Пишите: @sentrybuster

🚀 Готовое решение, которое работает.

Код написан на Python с заботой о производительности и безопасности.
"""
